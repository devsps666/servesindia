    ...
    <div className="min-h-screen bg-white text-gray-900 px-6 py-10">
      <header className="text-center mb-10">
        <div className="flex justify-center mb-4">
          <Image
            src="/logo.png"
            alt="ServesIndia Logo"
            width={80}
            height={80}
            className="rounded-full"
          />
        </div>
        <h1 className="text-4xl font-bold">ServesIndia</h1>
      ...
      <section className="mt-16 text-center">
        ...
        <p className="text-gray-700 max-w-xl mx-auto mb-4">
          We believe in the dignity of work. If you want to become a part of ServesIndia as a trained cleaning or maintenance professional, contact us to get trained and placed in your area.
        </p>
      ...
      <footer className="mt-16 text-center text-gray-600 text-sm">
        &copy; {new Date().getFullYear()} ServesIndia. All rights reserved.
      </footer>
    </div>
  );
}
